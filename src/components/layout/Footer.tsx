          ...
          <div className="md:col-span-3 grid grid-cols-2 md:grid-cols-3 gap-8">
            ...
            <div>
              ...
              <ul className="mt-4 space-y-2 text-sm">
                ...
                <li><Link href="/services" className="text-muted-foreground hover:text-primary">UI/UX Design</Link></li>
                <li><Link href="/services" className="text-muted-foreground hover:text-primary">Cloud Solutions</Link></li>
              </ul>
            </div>
            <div>
